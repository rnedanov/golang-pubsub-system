...
const file_pubsub_proto_rawDesc = "" +
	"\n" +
	"\fpubsub.proto\x12\x04main\x1a\x1bgoogle/protobuf/empty.proto\"$\n" +
	...
	"\rPubSubService\x122\n" +
	"\tSubscribe\x12\x16.main.SubscribeRequest\x1a\v.main.Event0\x01\x127\n" +
	"\aPublish\x12\x14.main.PublishRequest\x1a\x16.google.protobuf.EmptyB.Z,github.com/rnedanov/golang-pubsub-system/genb\x06proto3"
...
var file_pubsub_proto_goTypes = []any{
	(*SubscribeRequest)(nil), // 0: main.SubscribeRequest
	(*PublishRequest)(nil),   // 1: main.PublishRequest
	(*Event)(nil),            // 2: main.Event
	(*emptypb.Empty)(nil),    // 3: google.protobuf.Empty
}
var file_pubsub_proto_depIdxs = []int32{
	0, // 0: main.PubSubService.Subscribe:input_type -> main.SubscribeRequest
	1, // 1: main.PubSubService.Publish:input_type -> main.PublishRequest
	2, // 2: main.PubSubService.Subscribe:output_type -> main.Event
	3, // 3: main.PubSubService.Publish:output_type -> google.protobuf.Empty
